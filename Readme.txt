Installing Profile Field Identifier Plugin
---------------------
...
Search for Profile Field Identifier with an Install button, click the Install button then click Continue.
Confirm the installation request
Check the plugin validation report

Installing via uploaded ZIP file
Go to the Moodle plugins directory, select your current Moodle version, then choose Profile Field Identifier with a Download button and download the ZIP file.
...
Please unzip the Profile Field Identifier plugin in your moodle blocks folder.Now you can safely install the plugin.
